<div class="panel">
    <?php if ('' !== ($description = $currentLocation->getDescription())) { ?>
        <div class="panel-body">
            ...
            ><?= sprintf(lang('sampoyigi.local::default.text_info_heading'), $currentLocation->getName()); ?></h1>
    ...
    <h4 class="panel-title p-3"><b><?= lang('sampoyigi.local::default.text_hours'); ?></b></h4>
    <?= partial('@hours') ?>
</div>
