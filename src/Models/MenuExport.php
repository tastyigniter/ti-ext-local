...
class MenuExport extends ExportModel
{
    ...
    public $relation = [
        'belongsToMany' => [
            'menu_categories' => [\Igniter\Admin\Models\Category::class, 'table' => 'menu_categories', 'foreignKey' => 'menu_id'],
            'menu_mealtimes' => [\Igniter\Admin\Models\Mealtime::class, 'table' => 'menu_mealtimes', 'foreignKey' => 'menu_id'],
        ],
    ];
