...
class LocationOption extends Model
{
    ...
    /**
     * @var \Igniter\Local\Models\Location A user who owns the preferences
     */
    ...
    public static function getFieldsConfig()
    {
        ...
        $response = LocationDefineOptionsFieldsEvent::dispatch();
        ...
        if (is_array($response)) {
            foreach ($response as $fieldsConfig) {
                ...
                foreach ($fieldsConfig as $fieldName => $fieldConfig) {
                    ...
                    $fieldConfig['tab'] = 'lang:igniter.local::default.text_tab_options';
